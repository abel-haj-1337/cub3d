...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/01/13 16:23:08 by abel-haj          #+#    #+#             */
/*   Updated: 2021/01/13 16:23:09 by abel-haj         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "utils.h"

static void		ft_split_incr(char *s, size_t *i, char c, int equal_to)
{
	if (equal_to)
		while (s[*i] == c)
			*i += 1;
...
static size_t	ft_countsplit(char *s, char c)
{
	size_t	i;
	size_t	j;
